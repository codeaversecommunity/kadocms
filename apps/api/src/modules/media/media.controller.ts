...
import { CreateMediaDto, UpdateMediaDto, QueryMediaDto, UploadBase64Dto, TransformationDto } from './dto/media.dto';
...
export class MediaController {
  ...
  findAll(@Query() queryDto: QueryMediaDto, @CurrentUser() user: tbm_user) {
    return this.mediaService.findAll(queryDto, user.id);
  }
  ...
  generateTransformationUrl(
    ...
    return this.mediaService.generateTransformationUrl(id, transformationDto, user.id);
  }
